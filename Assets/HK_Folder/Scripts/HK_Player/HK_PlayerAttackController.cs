...
public class HK_PlayerAttackController : MonoBehaviour
{
    ...
    void FireBasedOnCharge(float timeHeld)
    {
        ...
        float dir = player.facingDir; // �÷��̾��� ������ ������
        Rigidbody2D rbProjectile = projectile.GetComponent<Rigidbody2D>();

        // �ҷ��� �ӵ��� ������ ����
        rbProjectile.linearVelocity = new Vector2(dir * shotSpeed, 0f);  // velocity�� ����
        projectile.transform.localScale = new Vector3(dir, 1, 1); // �ҷ��� ������/������ �ٶ󺸰� ����
    ...
    {
        bool isGrounded = player.IsGroundDetected(); // grounded ��� �Լ��� ȣ��
