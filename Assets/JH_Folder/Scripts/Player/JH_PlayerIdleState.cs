...
public class JH_PlayerIdleState : JH_PlayerGroundedState
{
    public JH_PlayerIdleState(JH_Player _player, JH_PlayerStateMachine _stateMachine, string _AnimBool) : base(_player, _stateMachine, _AnimBool)
    {
    }
