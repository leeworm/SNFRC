...
public class JH_PlayerBackJumpState : JH_PlayerState
{
    private float initialXVelocity;
    private bool Jumped;

    public JH_PlayerBackJumpState(JH_Player _Player, JH_PlayerStateMachine _StateMachine, string _AnimBool) : base(_Player, _StateMachine, _AnimBool)
    {
    }
