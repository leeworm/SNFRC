...
public class DH_EnemyTeleportJumpState : DH_EnemyState
{
    public DH_EnemyTeleportJumpState(DH_Enemy enemy, DH_EnemyStateMachine stateMachine, string animBoolName)
